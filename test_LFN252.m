...
N = 252;
N = int2str(N);
names = {'Data/small_N=252/N=252-2010-09--2010-12.mat';
'Data/small_N=252/N=252-2011-05--2011-08.mat';
'Data/small_N=252/N=252-2012-01--2012-04.mat';
'Data/small_N=252/N=252-2012-09--2012-12.mat';};
...
Fname = 'Data/small_N=252/F_N=252.txt';
data.F = load(Fname);
% keyboard
