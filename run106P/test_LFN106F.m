...
names = {'Data/small_N=106/N=106-2012-05--2012-08.mat'};
nFile = length(names);
...
[ T,G,params, LogLike_List ] = Gibbs_sampling(data, hyper, params,'LFN106F');
save('results6.mat','T','G','params','LogLike_List');
