...
names = {'Data/small_N=106/N=106-2011-01--2011-04.mat'};
nFile = length(names);
...
[ T,G,params, LogLike_List ] = Gibbs_sampling(data, hyper, params,'LFN106B');
save('results2.mat','T','G','params','LogLike_List');
