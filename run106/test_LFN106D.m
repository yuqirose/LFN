...
names = {'Data/small_N=106/N=106-2011-09--2011-12.mat'};
nFile = length(names);
...
[ T,G,params, LogLike_List ] = Gibbs_sampling(data, hyper, params,'LFN106D');
save('results4.mat','T','G','params','LogLike_List');
