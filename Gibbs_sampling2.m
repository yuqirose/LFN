...
for iter = 1:MaxIter
    for subiter = 1:MaxSubIter
        ...
        for p=1:N
            ...
            for q = p+1:N
                for m = 1:M
                    ...
                    prob_G = group_posterior( q,p, Dqpm, Gqpm_old, T_count(q,:),Gqp_count, params,hyper);
        ...
        % Check convergence
        [LogLike_new, loglike_new1, loglike_new2, loglike_new3] = loglike_LFN2(W,F,D,T,G,params,hyper);
